...
export function PrivacyPolicy() {
    return (
        <div className={"md-reader"}>
            ...
            <p>
                E-Mail-Adresse:{" "}
                <a href="mailto:marius.rosteck@gmail.com">marius.rosteck@gmail.com</a>
            </p>
            <p>
                Impressum:{" "}
                <a href="http://www.case-calc.com/impressum" target="_blank">
                    http://www.case-calc.com/impressum
                </a>
            </p>
            ...
            <p>
                ...
                1 DSGVO). Im Übrigen teilen wir Ihnen die Grundlagen der Drittlandübermittlung bei
                den einzelnen Anbietern aus dem Drittland mit, wobei die Angemessenheitsbeschlüsse
            ...
            <ul className="m-elements">
                <li>
                    ...
                    Sicherheitszwecken eingesetzt werden, z.&nbsp;B. um eine Überlastung der Server
                    ...
                    <strong>Löschung von Daten:</strong> Logfile-Informationen werden für die Dauer
            ...
            <p>
                ...
                auf Endgeräten speichern und aus ihnen auslesen. Zum Beispiel, um den Log-in-Status
                in einem Nutzerkonto, einen Warenkorbinhalt in einem E-Shop, die aufgerufenen
                Inhalte oder verwendete Funktionen eines Onlineangebots zu speichern. Cookies können
                ferner in Bezug auf unterschiedliche Anliegen Einsatz finden, etwa zu Zwecken der
            ...
            <p>
                <strong>Hinweise zur Einwilligung:&nbsp;</strong>Wir setzen Cookies im Einklang mit
                ...
                gefordert. Eine Erlaubnis ist insbesondere nicht notwendig, wenn das Speichern und
                das Auslesen der Informationen, also auch von Cookies, unbedingt erforderlich sind,
                um den Nutzern einen von ihnen ausdrücklich gewünschten Telemediendienst (also unser
            ...
            <p>
                ...
                welcher datenschutzrechtlichen Grundlage wir die personenbezogenen Daten der Nutzer
                ...
                betriebswirtschaftlichen Betrieb unseres Onlineangebots und der Verbesserung seiner
                Nutzbarkeit) verarbeitet oder, falls dies im Rahmen der Erfüllung unserer
            ...
            <ul>
                ...
                <li>
                    ...
                    im Rahmen der Einholung der Einwilligung), sollten sie davon ausgehen, dass
            ...
            <ul className="m-elements">
                <li>
                    ...
                    sie betreffenden Informationen, wie z. B. Angaben zur Autorenschaft oder
            ...
            <p>
                ...
                nur die zum Zweck der jeweiligen Verfahren in deren Profilen gespeicherten Angaben.
            </p>
            <p>
            ...
            <ul className="m-elements">
                <li>
                    ...
                    Onlineangebot verweisen und technische Aspekte ihrer Endgeräte und Browser.
                    <br />
